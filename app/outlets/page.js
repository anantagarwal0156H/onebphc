...
{ 
  ...
  { item: "--- SANDWICHES ---", price: "" },
  { item: "Veg", price: "₹65" },
  { item: "Veg Cheese", price: "₹75" },
  { item: "Paneer", price: "₹75" },
  { item: "Chicken", price: "₹90" },

  { item: "--- BURGERS ---", price: "" },
  { item: "Veg", price: "₹85" },
  { item: "Chicken", price: "₹95" },

  { item: "--- CAKES ---", price: "" },
  { item: "Brownie Slice", price: "₹60" },
  { item: "Brownie Icecream", price: "₹75" },
  { item: "Banana Cake", price: "₹40" },
  { item: "Cookiee", price: "₹40" },

  { item: "--- FRIES ---", price: "" },
  { item: "French Fries", price: "₹65" },
  { item: "Cheese Fries", price: "₹80" },

  { item: "--- JUICES ---", price: "" },
  { item: "Watermelon / Pineapple", price: "₹50" },
  { item: "Mosambi / Carrot / Beetroot", price: "₹50" },

  { item: "--- MILKSHAKES ---", price: "" },
  { item: "Chocolate / Banana / Oreo", price: "₹55" },
  { item: "Black Current", price: "₹60" },
  { item: "Blueberry", price: "₹60" },
  { item: "Strawberry", price: "₹55" },

  { item: "--- TIFFINS ---", price: "" },
  { item: "Plain Dosa / Idly Sambar", price: "₹50" },
  { item: "Masala Dosa / Onion Dosa", price: "₹60" },
  { item: "Egg Dosa / Cheese Dosa", price: "₹70" },
  { item: "Roti Bhaji / Poori / Shrikhand", price: "₹60" },
  { item: "Utthappam", price: "₹80" },
  { item: "Mirchi Bajji / Aaloo Bajji", price: "₹40" },
  { item: "Egg Bajji", price: "₹35" },

  { item: "--- BEVERAGES & OTHERS ---", price: "" },
  { item: "Mojitho / Lime Soda / Cold Coffee", price: "₹50/50/55" },
  { item: "Hot Chocolate / Masala Tea", price: "₹50/15" },
  { item: "Coffee", price: "₹25" },
  { item: "Paneer / Puran Poli", price: "₹65/40" },
  { item: "Chicken Cutlet / Bread Omlette", price: "₹50/50" },
  { item: "Boiled Egg / Omlette", price: "₹10/15" },
  { item: "Vada Pav", price: "₹35" }

] },
      { name: 'Protein Isle', time: '5:00 PM - 11:00 PM', desc: 'The gym-rat go-to. High-protein bowls.', menu: [
  { item: "--- SALADS (VEGAN & VEG) ---", price: "" },
  { item: "Chicken Salad (~30gm Protein)", price: "₹159" },
  { item: "Paneer Salad (~22gm Protein)", price: "₹159" },
  { item: "Soya Chunks Salad (~23gm Protein)", price: "₹129" },
  { item: "Chickpeas Salad (~19gm Protein)", price: "₹129" },

  { item: "--- AIRFRIED PROTEIN ---", price: "" },
  { item: "Airfried Chicken Breast (per gm)", price: "₹1.09" },
  { item: "Airfried Paneer (per gm)", price: "₹0.99" },
  { item: "Airfried Soya Chunks", price: "₹40" },
  { item: "Airfried Chickpeas", price: "₹40" },

  { item: "--- SANDWICHES & TOAST ---", price: "" },
  { item: "Chicken Sandwich (~20gm Protein)", price: "₹109" },
  { item: "Paneer Sandwich (~17gm Protein)", price: "₹109" },
  { item: "Peanut Butter Toast (~9gm Protein)", price: "₹49" },

  { item: "--- PROTEIN THICKSHAKES ---", price: "" },
  { item: "Choco Crisper Shake (MuscleBlaze)", price: "₹169" },
  { item: "Blue Tokai Coffee Shake (MuscleBlaze)", price: "₹179" },

  { item: "--- ADD-ONS ---", price: "" },
  { item: "Boiled Egg", price: "₹15" },
  { item: "Chickpeas / Soya Chunks", price: "₹20" },
  { item: "Dressing of Choice", price: "₹9" },
  { item: "Extra Olives & Jalapeños", price: "₹5" }
